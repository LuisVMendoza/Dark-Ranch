...
const defaultStore = {
  categories: [
    { id: 'cat_botas', name: 'Botas', slug: 'botas', imageUrl: '/assets/Botas.png' },
    { id: 'cat_sombreros', name: 'Sombreros', slug: 'sombreros', imageUrl: '/assets/Sombreros.png' },
    { id: 'cat_camisas', name: 'Camisas', slug: 'camisas', imageUrl: '/assets/Camisas.png' },
    { id: 'cat_jeans', name: 'Jeans', slug: 'jeans', imageUrl: '/assets/Jeans.png' },
    { id: 'cat_cinturones', name: 'Cinturones', slug: 'cinturones', imageUrl: '/assets/Cinturones.png' },
    { id: 'cat_accesorios', name: 'Accesorios', slug: 'accesorios', imageUrl: '/assets/acessorios.png' },
  ],
  products: [
    { id: 'dr-001', name: 'Bota Vaquera Cuero Negro', slug: 'bota-vaquera-cuero-negro', description: 'Construida para durar. Cuero de grano entero con acabado industrial. Suela resistente al aceite y costuras reforzadas.', price: 189.99, salePrice: null, category: 'Botas', images: ['/assets/Botas.png'], sizes: ['7', '8', '9', '10', '11', '12'], colors: ['Negro'], tags: ['Industrial', 'Western', 'Cuero'], stock: 15, isNew: true, isFeatured: true, isActive: true, createdAt: '2026-01-10T10:00:00Z' },
    { id: 'dr-008', name: 'Cinto Pitón Industrial', slug: 'cinto-piton-industrial', description: 'Cuero con grabado exótico. Herrajes de latón envejecido.', price: 89, salePrice: null, category: 'Cinturones', images: ['/assets/Cinturones.png'], sizes: ['32', '34', '36', '38'], colors: ['Negro'], tags: ['Accesorios'], stock: 15, isNew: false, isFeatured: true, isActive: true, createdAt: '2026-01-11T10:00:00Z' },
    { id: 'dr-009', name: 'Sombrero Dust Rider', slug: 'sombrero-dust-rider', description: 'Fieltro rígido, corona alta. El favorito de los outlaws.', price: 145, salePrice: null, category: 'Sombreros', images: ['/assets/Sombreros.png'], sizes: ['M', 'L'], colors: ['Arena'], tags: ['Western'], stock: 8, isNew: false, isFeatured: true, isActive: true, createdAt: '2026-01-12T10:00:00Z' },
    { id: 'dr-010', name: 'Camisa Denim Hard-Work', slug: 'camisa-denim-hard-work', description: 'Denim de 12oz. Triple costura para durabilidad extrema.', price: 85, salePrice: null, category: 'Camisas', images: ['/assets/Camisas.png'], sizes: ['M', 'L', 'XL', 'XXL'], colors: ['Indigo'], tags: ['Industrial'], stock: 20, isNew: false, isFeatured: true, isActive: true, createdAt: '2026-01-13T10:00:00Z' },
    { id: 'dr-002', name: 'Sombrero Felt Premium', slug: 'sombrero-felt-premium', description: 'Fieltro de alta calidad. Resistente al agua y al polvo del desierto.', price: 125, salePrice: null, category: 'Sombreros', images: ['/assets/Sombreros.png'], sizes: ['S', 'M', 'L', 'XL'], colors: ['Marrón', 'Negro'], tags: ['Western', 'Premium'], stock: 22, isNew: false, isFeatured: true, isActive: true, createdAt: '2026-01-09T10:00:00Z' },
    { id: 'dr-003', name: 'Cinturón Hebilla Acero', slug: 'cinturon-hebilla-acero', description: 'Hebilla forjada a mano. Cuero curtido vegetal de 4mm.', price: 55, salePrice: null, category: 'Cinturones', images: ['/assets/Cinturones.png'], sizes: ['30', '32', '34', '36'], colors: ['Café'], tags: ['Accesorios', 'Industrial'], stock: 45, isNew: true, isFeatured: false, isActive: true, createdAt: '2026-01-08T10:00:00Z' },
    { id: 'dr-004', name: 'Jeans Industrial Raw', slug: 'jeans-industrial-raw', description: 'Denim japonés de 14oz. Corte recto, remaches de cobre y triple costura.', price: 95, salePrice: null, category: 'Jeans', images: ['/assets/Jeans.png'], sizes: ['30', '32', '34', '36'], colors: ['Indigo'], tags: ['Industrial', 'Denim'], stock: 30, isNew: false, isFeatured: true, isActive: true, createdAt: '2026-01-07T10:00:00Z' },
    { id: 'dr-005', name: 'Camisa Chambray Western', slug: 'camisa-chambray-western', description: 'Tela chambray ligera pero resistente. Botones de perla y canesú estilo western clásico.', price: 75, salePrice: null, category: 'Camisas', images: ['/assets/Camisas.png'], sizes: ['S', 'M', 'L', 'XL'], colors: ['Azul', 'Gris'], tags: ['Western', 'Camisas'], stock: 25, isNew: false, isFeatured: false, isActive: true, createdAt: '2026-01-06T10:00:00Z' },
    { id: 'dr-006', name: 'Bota Ranchera Tabaco', slug: 'bota-ranchera-tabaco', description: 'Cuero color tabaco con pátina natural. Comodidad excepcional desde el primer día.', price: 165, salePrice: null, category: 'Botas', images: ['/assets/Botas.png'], sizes: ['8', '9', '10', '11'], colors: ['Tabaco'], tags: ['Western', 'Confort'], stock: 10, isNew: false, isFeatured: false, isActive: true, createdAt: '2026-01-05T10:00:00Z' },
    { id: 'dr-007', name: 'Chaqueta Denim Forrada', slug: 'chaqueta-denim-forrada', description: 'Forro de lana sintética para los inviernos en el rancho. Exterior de mezclilla pesada.', price: 145, salePrice: 129, category: 'Accesorios', images: ['/assets/acessorios.png'], sizes: ['M', 'L', 'XL'], colors: ['Indigo'], tags: ['Invierno', 'Premium'], stock: 12, isNew: false, isFeatured: false, isActive: true, createdAt: '2026-01-04T10:00:00Z' },
  ],
  settings: {
    hero: {
...
function updateStoreSettings(store, payload) {
  store.settings = {
    ...
    banners: payload.banners.map((banner, index) => ({
      ...
      galleryImages: Array.isArray(banner.galleryImages) ? banner.galleryImages.filter(Boolean).slice(0, 8) : [],
