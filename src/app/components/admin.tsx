              ...
              <PaperCard>
                <div className="flex items-center justify-between gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button size="sm" variant="outline" onClick={() => setIsCleanupModalOpen(true)} aria-label="Opciones de limpieza de bitácora">
                      <Settings size={16} />
                    </Button>
                  </div>
                </div>
          ...
          <Dialog open={isCleanupModalOpen} onOpenChange={setIsCleanupModalOpen}>
            <DialogContent className="max-w-xl border-2 border-black bg-[#fcf9f5]">
              ...
              <div className="flex justify-end gap-3 mt-6">
                <Button variant="outline" size="sm" onClick={() => setIsCleanupModalOpen(false)}>Cancelar</Button>
                <Button
                  size="sm"
                  onClick={async () => {
