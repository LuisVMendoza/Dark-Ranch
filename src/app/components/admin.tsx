  ...
  return (
    <form onSubmit={onSubmit} className="relative flex h-full min-h-0 flex-col">
      <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-8 sm:py-6">
        <div className="ml-auto w-full max-w-[860px] space-y-5">
          <section className="sticky top-0 z-20 space-y-4 border-2 border-black bg-white p-4 shadow-[0_6px_0_0_rgba(0,0,0,0.12)] sm:p-5">
            <div className="flex items-center justify-between gap-3">
      ...
      <div className="sticky bottom-0 z-20 ml-auto w-full max-w-[860px] border-t-2 border-black bg-[#1f130b] px-5 py-4 sm:px-8">
